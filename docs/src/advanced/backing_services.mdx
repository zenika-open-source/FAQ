...
route: /advanced/backing-services
menu: Advanced
---
...
> If you have an @zenika.com email address, you can use the following credentials:
>
...
| Name            | Notes                                                                                                                                                                                                                         |
| --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `mailgunDomain` | Its value should be the domain associated with the email sent by this project (eg: faq.team). It can be found on the [Mailgun dashboard](https://app.mailgun.com).                                                            |
