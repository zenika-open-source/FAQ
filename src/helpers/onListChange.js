...
export const onListChangeActions = (prefix, dispatch, ctx) => ({
  create: data => dispatch({ type: `${prefix}_create`, data, ctx }),
  update: data => dispatch({ type: `${prefix}_update`, data, ctx }),
  delete: data => dispatch({ type: `${prefix}_delete`, data, ctx })
})
